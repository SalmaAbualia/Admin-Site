...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `blogs` (`img`, `title`, `suptitle`, `description`, `bloogername`, `date`) VALUES ('$img', '$title', '$suptitle', '$description', '$bloogername', '$date')";
            ...
            <form method="post">
                <div class="edit">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" class="form-control" placeholder="img" aria-label="img" aria-describedby="basic-addon1" name="img">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="suptitle" aria-label="suptitle" aria-describedby="basic-addon1" name="suptitle">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="bloogername" aria-label="bloogername" aria-describedby="basic-addon1" name="bloogername">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Date</span>
                        <input type="date" class="form-control" placeholder="date" aria-label="date" aria-describedby="basic-addon1" name="date">
                    </div>
